package com.hbqilufc.module.system.service.social;
...
import com.hbqilufc.framework.common.util.cache.CacheUtils;
import com.hbqilufc.framework.common.util.http.HttpUtils;
import com.hbqilufc.framework.common.util.object.BeanUtils;
import com.hbqilufc.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.hbqilufc.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.hbqilufc.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.hbqilufc.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.hbqilufc.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.hbqilufc.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.hbqilufc.module.system.dal.dataobject.social.SocialClientDO;
import com.hbqilufc.module.system.dal.mysql.social.SocialClientMapper;
import com.hbqilufc.module.system.dal.redis.RedisKeyConstants;
import com.hbqilufc.module.system.enums.social.SocialTypeEnum;
import com.hbqilufc.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.hbqilufc.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.hbqilufc.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.hbqilufc.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${aicos.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${aicos.wxa-subscribe-message.miniprogram-state:formal}")

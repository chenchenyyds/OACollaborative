...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.hbqilufc";
    private static final String ARTIFACT_ID = "aicos";
    private static final String PACKAGE_NAME = "com.hbqilufc";
    private static final String TITLE = "AI协同办公系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.hbqilufc";
        String artifactIdNew = "aicos";
        String packageNameNew = "com.hbqilufc";
        String titleNew = "AI协同办公系统";
        String projectBaseDirNew = "D:/workspace/idea/hbqilufc"; // 一键改名后，“新”项目所在的目录

package com.hbqilufc.module.bpm.service.task;
...
import com.hbqilufc.framework.common.util.collection.CollectionUtils;
import com.hbqilufc.framework.common.util.date.DateUtils;
import com.hbqilufc.framework.common.util.json.JsonUtils;
import com.hbqilufc.framework.common.util.object.ObjectUtils;
import com.hbqilufc.framework.common.util.object.PageUtils;
import com.hbqilufc.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.hbqilufc.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.hbqilufc.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.hbqilufc.module.bpm.controller.admin.task.vo.instance.*;
import com.hbqilufc.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.hbqilufc.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.hbqilufc.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.hbqilufc.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.hbqilufc.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.hbqilufc.module.bpm.enums.ErrorCodeConstants;
import com.hbqilufc.module.bpm.enums.definition.BpmModelTypeEnum;
import com.hbqilufc.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.hbqilufc.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.hbqilufc.module.bpm.enums.task.BpmReasonEnum;
import com.hbqilufc.module.bpm.enums.task.BpmTaskStatusEnum;
import com.hbqilufc.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.hbqilufc.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.hbqilufc.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.hbqilufc.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.hbqilufc.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.hbqilufc.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.hbqilufc.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.hbqilufc.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.hbqilufc.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.hbqilufc.module.bpm.service.definition.BpmProcessDefinitionService;
import com.hbqilufc.module.bpm.service.message.BpmMessageService;
...
import static com.hbqilufc.framework.common.exception.util.ServiceExceptionUtil.exception;
import static com.hbqilufc.framework.common.util.collection.CollectionUtils.*;
import static com.hbqilufc.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.hbqilufc.module.bpm.enums.ErrorCodeConstants.*;
import static com.hbqilufc.module.bpm.enums.task.BpmReasonEnum.REJECT_CHILD_PROCESS;
import static com.hbqilufc.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.hbqilufc.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;

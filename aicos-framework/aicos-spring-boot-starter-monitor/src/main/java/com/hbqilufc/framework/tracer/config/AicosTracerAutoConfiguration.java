package com.hbqilufc.framework.tracer.config;

import com.hbqilufc.framework.common.enums.WebFilterOrderEnum;
import com.hbqilufc.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "aicos.tracer", value = "enable", matchIfMissing = true)
public class AicosTracerAutoConfiguration {

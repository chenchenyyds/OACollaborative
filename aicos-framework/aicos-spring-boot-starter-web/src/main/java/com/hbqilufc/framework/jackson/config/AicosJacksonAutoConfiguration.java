package com.hbqilufc.framework.jackson.config;

import com.hbqilufc.framework.common.util.json.JsonUtils;
import com.hbqilufc.framework.common.util.json.databind.NumberSerializer;
import com.hbqilufc.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.hbqilufc.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class AicosJacksonAutoConfiguration {

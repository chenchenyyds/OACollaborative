package com.hbqilufc.module.crm.controller.admin.product.vo.product;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "com.hbqilufc.module.system.dal.dataobject.user.AdminUserDO",
